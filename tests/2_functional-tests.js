  ...
  describe('PUT /api/issues/:project', function() {
    it('should update one field on an issue', function(done) {
      chai
       ...
       .send({
          _id: 'valid_issue_id', // Replace with a real issue ID
    ...
    it('should return an error when updating issue with missing _id', function(done) {
      chai
       .request(server)
       .put(`/api/issues/test-project`)
       .send({
    ...
    it('should return an error when updating issue with no fields to update', function(done) {
      chai
       .request(server)
       .put(`/api/issues/test-project`)
       .send({
    ...
    it('should return an error when updating issue with an invalid _id', function(done) {
      chai
       .request(server)
       .put(`/api/issues/test-project`)
       .send({
